...
class ApiController extends Controller
{
    ...
    /**
     * GET /api/elections/{election}/results - Get results for specific election
     */
    public function getElectionResults(Election $election): JsonResponse
    {
        return $this->getResults($election);
    }
}
